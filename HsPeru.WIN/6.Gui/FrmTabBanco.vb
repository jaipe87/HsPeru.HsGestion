...
#Region "Métodos"
    ...
    Sub Graba()
        ...
        If txtDes.Text.Trim.Length = 0 Then MessageBox.Show("Ingrese el nombre de la cuenta de banco", TITULO, MessageBoxButtons.OK, MessageBoxIcon.Information) : Return
