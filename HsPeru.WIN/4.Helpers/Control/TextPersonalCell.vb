Public Class TextPersonalCell
    ...
    Public Overrides ReadOnly Property EditType As Type
        Get
            Return GetType(TextPersonalEditingControl)
        End Get
    End Property
    ...
    Public Overrides Sub InitializeEditingControl(rowIndex As Integer, initialFormattedValue As Object,
        ...
        Dim ctl As TextPersonalEditingControl = CType(DataGridView.EditingControl, TextPersonalEditingControl)
        Try
