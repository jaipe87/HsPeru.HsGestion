Public Class TextFloatCell
    ...
    Public Overrides ReadOnly Property EditType As Type
        Get
            Return GetType(TextFloatEditingControl)
        End Get
    End Property
    ...
    Public Overrides Sub InitializeEditingControl(rowIndex As Integer, initialFormattedValue As Object,
        ...
        Dim ctl As TextFloatEditingControl = CType(DataGridView.EditingControl, TextFloatEditingControl)
        Try
